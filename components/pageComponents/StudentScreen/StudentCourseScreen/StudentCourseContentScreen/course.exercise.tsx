...
const CourseExerciseTab = (props: any) => {
  ...
  const exerciseRows = exercise.map((element: any) => {
    ...
    return (
      <tr key={element.id}>
        <td>
          <Text align="center">{element.name}</Text>
        </td>
        <td>
          <Text align="center">
            {moment(openTime).format("hh:mm - DD/MM/YYYY")}
          </Text>
        </td>
        <td>
          <Text align="center">
        ...
        <td>
          <Text align="center">{element.maxTime}</Text>
        </td>
        <td>
          <Text align="center">{times}</Text>
        </td>
        <td>
          <Text align="center">{times === 0 ? "-" : maxGrade}</Text>
        </td>
  ...
  const questionRows = useMemo(
    () =>
      selectedExercise === null
        ? null
        : selectedExercise.questions.map((element: any, idx: number) => {
            const answer = [
              {
                id: element.id,
              ...
              <Group position="center" mt={"md"}>
                ...
                <Table withBorder withColumnBorders highlightOnHover>
                  <thead>
                    <tr>
                      <th>
                        <Text align="center">Tên bài tập</Text>
                      </th>
                      <th>
                        <Text align="center">Thời gian mở</Text>
                      </th>
                      <th>
                        <Text align="center">Thời gian kết thúc</Text>
                      </th>
                      <th>
                        <Text align="center">Số lần thục hiện tối đa</Text>
                      </th>
                      <th>
                        <Text align="center">Số lần đã thục hiện</Text>
                      </th>
                      <th>
                        <Text align="center">Điểm cao nhất</Text>
                      </th>
                      <th></th>
                    </tr>
                  </thead>
