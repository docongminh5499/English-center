...
const schema = yup.object().shape({
  ...
  openingDate: yup.date()
    ...
    .min(new Date((new Date()).setDate((new Date()).getDate() + 1)), "Vui lòng chọn ngày khai giảng sau ngày hiên tại"),
...
const EmployeeCreateCourseScreen = (props: IProps) => {
  ...
  }, [createCourseForm.values['curriculum'], createCourseForm.values['teacher'], createCourseForm.values['openingDate'].toString()])
